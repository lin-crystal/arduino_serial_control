...
void process_pid_controller() {
  ...
  //Serial.print("  motor left = ");Serial.print(r_mot_left);
  //Serial.print("  current ticks/round = ");Serial.print(actTicksDiffLeft);
  //Serial.print("  motor right = ");Serial.print(r_mot_right);
  //Serial.print("  current ticks/round = ");Serial.println(actTicksDiffRight);
}
